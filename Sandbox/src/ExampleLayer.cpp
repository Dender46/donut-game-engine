...
public:
		...
		: Layer("OpenGLExampleLayer"), m_CameraController(1280.0f / 720.0f, true)
	{
		...
		vertexBuffer = Donut::VertexBuffer::Create(vertices, sizeof(vertices));
		...
		indexBuffer = Donut::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
		...
		squareVertexBuffer = Donut::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
		...
		squareIndexBuffer = Donut::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
